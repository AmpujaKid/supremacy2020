...
void Form::draw( ) {
	...
	render::rect( m_x + 1, m_y + 1, m_width - 2, m_height - 2, { 0, 0, 0, 110 } );
	render::rect( m_x + 2, m_y + 2, m_width - 4, m_height - 4, { 0, 0, 0, 110 } );
	render::rect( m_x + 3, m_y + 3, m_width - 6, m_height - 6, { 0, 0, 0, 110 } );
	render::rect( m_x + 4, m_y + 4, m_width - 8, m_height - 8, { 0, 0, 0, 110 } );
	render::rect( m_x + 5, m_y + 5, m_width - 10, m_height - 10, { 0, 0, 0, 110 } );
	...
	if( !m_tabs.empty( ) ) {
		...
		if( !m_active_tab->m_elements.empty( ) ) {
			...
			std::string text = tfm::format( XOR( "leetgrail alpha" ));
